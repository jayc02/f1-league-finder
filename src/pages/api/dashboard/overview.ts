...
export const GET: APIRoute = (context) =>
  withErrorHandling(async () => {
    ...
    const { upcomingRegistrations, upcomingEvents, myDuels, organiserProfile, staffMembership } = await getDashboardPageData(user.id);
    ...
    return jsonResponse(200, { upcomingRegistrations, upcomingEvents, myDuels, managedCommunity, organiserCtaLabel });
  });
