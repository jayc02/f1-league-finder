  ...
  return (
    <section className="section-shell" data-reveal>
      <div className="grid items-center gap-8 lg:grid-cols-2">
        <div>
          <p className="text-xs uppercase tracking-[0.25em] text-slate-400">Honour rating</p>
          <h2 className="section-title mt-3">Win clean or lose trust.</h2>
          <p className="mt-5 text-lg text-slate-300">Clean racing matters. Disputes and poor conduct affect your honour.</p>
        </div>
        <div className="panel rounded-3xl p-8">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Clean racing badge</p>
