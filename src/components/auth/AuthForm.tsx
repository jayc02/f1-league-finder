    ...
    <form onSubmit={onSubmit} className="panel mx-auto w-full max-w-xl rounded-3xl p-6 md:p-8">
      ...
      <div className="mt-6 space-y-3">
        <a
          ...
          className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-slate-300 bg-white px-4 text-base font-medium text-slate-800 transition hover:bg-slate-50"
        >
        ...
        <a
          ...
          className="flex h-12 w-full items-center justify-center rounded-xl bg-[#5865F2] px-4 text-base font-medium text-white transition hover:bg-[#4d59d9]"
        >
